...
use \Interface\Model;
use \Interface\Rule;
use \Interface\Validate;

class User extends Model{

         
            const SESSION = $_ENV['_USER_SESSION'];
            const ERROR = $_ENV['_USER_ERROR'];
            const SUCCESS = $_ENV['_USER_SUCCESS'];
            const SECRET = $_ENV['_USER_SECRET'];
            const REGISTER_VALUES = $_ENV['_USER_REGISTER_VALUES'];
